...
<div id="content" class="container my-4 my-md-5">
                ...
                if($sites_type == "down") include( 'templates/content-down.php' );
                else include( 'templates/content-site.php' );
                ?>
                    ...
                    if ($i < $post_num) {
                        ...
                        if ($related_items->have_posts()) :
                            ...
                            ?>
                                ...
                                <?php include( 'templates/card-site.php' ); ?>
                                </div>
...
<script type='text/javascript'>
    ...
    function ipanalysis(ip){
        $.getJSON('//api.ooopn.com/ip/api.php?ip='+ip,function(data){
            if(data.country){
