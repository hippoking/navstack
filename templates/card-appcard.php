	...
	<div class="card-app card">
	    <div class="card-body align-items-center d-flex flex-fill py-3">
            ...
            <div class="app-content flex-fill pl-2 pr-1">
                <div class="mb-2"><a href="<?php the_permalink(); ?>" <?php echo new_window() ?> class="text-md overflowClip_1"><?php the_title(); ?><?php echo  '<span class="text-xs"> - '.get_post_meta(get_the_ID(), 'app_down_list', true)[0]['app_version'].'</span>' ?></a></div>
