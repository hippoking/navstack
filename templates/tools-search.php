...
<div id="search" class="s-search mx-auto my-4">
        ...
        <div class="s-type">
            ...
            <div class="s-type-list">
                <?php foreach ($search_list as $value) {
                    echo '<label for="'.$value['default'].'">'.$value['name'].'</label>';
                } ?>
            </div>
        </div>
    ...
    <form action="<?php echo home_url() ?>?s=" method="get" target="_blank" class="super-search-fm">
        <input type="text" id="search-text" class="form-control search-key" placeholder="<?php _e( '输入关键字搜索', 'i_theme' ); ?>" style="outline:0">
