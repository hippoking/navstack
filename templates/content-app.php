                ...
                <div class="col">
                    <div class="d-md-flex mt-n3 mb-5 my-xl-0">
                        <div class="app-ico text-center mr-0 mr-md-2 mb-3 mb-md-0">
                            ...
                            <img class="app-rounded mr-0 mr-md-3 lazy" src="<?php echo $default_ico; ?>" data-src="<?php echo $app_ico ?>" width="128" alt="<?php echo get_post_meta(get_the_ID(), '_app_name', true)  ?>">
                            <?php else: ?>
                            <img class="app-rounded mr-0 mr-md-3" src="<?php echo $app_ico ?>" width="128" alt="<?php echo get_post_meta(get_the_ID(), '_app_name', true)  ?>">
                            <?php endif ?>
                        </div>
                        <div class="app-info">
                            <h3 class="text-center text-md-left mb-0"><?php echo get_post_meta(get_the_ID(), '_app_name', true)?:get_the_title() ?>
                            ...
                            <p class="text-muted mb-4">
                                ...
                                <span class="info-term mr-3"><?php _e('分类标签：','i_theme') ?><?php the_terms( get_the_ID(), 'apps','<span class="mr-2">', '</span> <span class="mr-2">', '</span>' ); ?><?php the_terms( get_the_ID(), 'apptag','<span class="mr-2">', '</span> <span class="mr-2">', '</span>' ); ?></span>
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel"> 
                            <div class="carousel-inner" role="listbox"> 
                                ...
                                <div class="carousel-item <?php echo $i==0?'active':'' ?>"> 
                                    ...
                                    <?php if(io_get_option('lazyload')): ?>
                                    <img src="" data-src="<?php echo wp_get_attachment_image_src( $app_screen[$i], 'full' )[0] ?>" class="img-fluid lazy" alt="<?php echo get_post_meta(get_the_ID(), '_app_name', true)  ?><?php _e('使用截图','i_theme') ?>">
                                    <?php else: ?>
                                    <img src="<?php echo wp_get_attachment_image_src( $app_screen[$i], 'full' )[0] ?>" class="img-fluid" alt="<?php echo get_post_meta(get_the_ID(), '_app_name', true)  ?><?php _e('使用截图','i_theme') ?>">
                                    <?php endif ?>
                                    </div> 
                                </div> 
                                <?php } ?>
            ...
            <div class="card historic"> 
		        <div class="card-body" id="accordionExample">
                    <div class="row row-sm text-center ">  
                        <div class="col "><?php _e('版本','i_theme') ?></div>
                        ...
                        <div class="col "><?php _e('下载','i_theme') ?></div> 
                    ...
                    <div class="row row-sm text-center" data-toggle="collapse" data-target="#collapse<?php echo $i ?>" aria-expanded="true" aria-controls="collapse<?php echo $i ?>">  
                        <div class="col "><?php echo($down['app_version']);if($i==0)echo'<span class="badge badge-danger ml-1">'.__('最新','i_theme').'</span>'; ?></div>
                        ...
                        <div class="col "><button type="button" class="btn btn-sm btn-danger custom_btn-d btn_down my-n1" data-id="<?php echo $i ?>" data-toggle="modal" data-target="#app-down-modal"><?php _e('下载','i_theme') ?></button></div>
                        <div class="col-12 line-tbody my-3" style="height:1px"> </div> 
                    </div>  
                    <?php if($down['version_describe']) { ?>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">  
                        <div class="modal-body down_body"> 
                            <h4 class="h6"><?php _e('下载地址: ','i_theme') ?><?php echo get_post_meta(get_the_ID(), '_app_name', true) ?> - <span class="app-v">1.00</span></h4>
                            <div class="down_btn_list text-center my-4">
...
<script type="text/javascript">
    ...
    $(document).on('click','button.btn_down',function(ev) {
        ...
        for(var i=0;i<down.down_url.length;i++){
            var url = is_go?home+'/go/?url='+down.down_url[i].down_btn_url:down.down_url[i].down_btn_url;
            var html = '<div class="my-3"><a class="btn btn-danger custom_btn-d mx-auto down_count" href="'+url+'" target="_blank" data-id="<?php echo get_the_ID() ?>" data-action="down_count" data-mmid="down-mm-'+i+'">'+down.down_url[i].down_btn_name+'</a>';
            if(down.down_url[i].down_btn_tqm!="")
                html += '<p class="text-muted text-sm"><?php _e('提取码：','i_theme') ?>'+down.down_url[i].down_btn_tqm+'</p><input type="text" style="width:1px;position:absolute;height:1px;background:transparent;border:0px solid transparent" name="down-mm-'+i+'" value="'+down.down_url[i].down_btn_tqm+'" id="down-mm-'+i+'">';
            html += '</div>';
