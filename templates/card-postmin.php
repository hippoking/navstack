<?php if ( ! defined( 'ABSPATH' ) ) { exit; }  ?>
        ...
        <div class="card flex-fill mb-3" >
            <div class="row no-gutters">
                ...
                <div class="col-8">
                    <div class="card-body list-content p-3" style="height: 100%;"> 
                        <div class="list-body"> 
                    
            				<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>" class="list-title no-c text-md overflowClip_1"><?php the_title(); ?></a>
