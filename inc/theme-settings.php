...
CSF::createSection( $prefix, array(
    ...
    'fields' => array(
        array(
            ...
            'after'   => '<br>'.__('此 key 用于<br>1、添加网址时自动获取网址标题、关键字等信息的 api 验证<br>2、热搜榜、新闻源等卡片获取数据的 api 验证（未上线）<br><br>找作者免费索取','io_setting'),
            'default' => false,
        ),
        array(
            'id'      => 'min_nav',
        ...
        array(
            ...
            'label'   => __('在网址详情页显示目标网址的链接速度、国家地址等信息','io_setting'),
        ...
        array(
            'id'      => 'is_go',
            'type'    => 'switcher',
            'title'   => __('内链跳转','io_setting'),
            'label'   => __('效果：http://您的域名/go/?url=外链','io_setting'),
            'default' => false,
        ),
        array(
            'id'      => 'save_image',
...
CSF::createSection( $prefix, array(
    ...
    'fields'      => array(
        ...
        array(
            'id'      => 'ad_app_s',
            'type'    => 'switcher',
            'title'   => __('app详情页广告位','io_setting'),
            'default' => true,
        ),
        array(
            'id'         => 'ad_app',
            'type'       => 'code_editor',
            'title'      => ' ┗━━ '. __('app详情页广告位内容','io_setting'),
            'default'    => '<a href="https://www.iowen.cn/wordpress-version-webstack/" target="_blank"><img src="' . get_theme_file_uri('/images/ad.jpg').'" alt="广告也精彩" /></a>',
            'settings'   => array(
                'theme'  => 'dracula',
                'mode'   => 'javascript',
...
CSF::createSection( $prefix, array(
    ...
    'fields'      => array( 
        ...
        array(
            ...
            'type'    => 'switcher',
            'title'   => '兼容性切换',
            'label'   => '主题 2.0218.2 版本和之前的版本升级到最新版兼容性修改。',
            'after'   => '<p style="color: #f12345;font-size: 18px;">不用管，可以关掉。</p>',
            'default' => true,
        ),
    )
));
