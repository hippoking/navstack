...
class cx_tag_cloud extends WP_Widget {
	...
	?> 
		...
		<div class="tags text-justify">
			<?php 
			$tax = array('post_tag','apptag','sitetag');
    ...
    <div class="widget-author-meta text-center p-4">
	    ...
	    <div class="row no-gutters text-center my-3">
			...
			<?php if($instance['tqqurl']) { ?> 
	      	<div class="col">
			  <a target=blank rel="external nofollow" href=http://wpa.qq.com/msgrd?V=3&uin=<?php echo $instance['tqqurl']; ?>&Site=QQ&Menu=yes  data-toggle="tooltip" data-placement="top" title="<?php _e('QQ在线','i_theme') ?>"><i class="iconfont icon-qq icon-lg"></i></a>
	      	</div>
			<?php } ?>
